...
from Config import STRING, SUDO, USERNAME, BIO_MESSAGE, API_ID, API_HASH, STRING2, STRING3, STRING4 ,STRING5, STRING6, STRING7, STRING8 ,STRING9, STRING10, STRING11, STRING12 , STRING13 , STRING14 , STRING15 ,STRING16 , STRING17 , STRING18 , STRING19 , STRING20 , STRING21 , STRING22 , STRING23 , STRING24 , STRING25 
import asyncio
...
async def alive(e):
    if e.sender_id in SMEX_USERS:
        text = "THODA RUKO!"
        event = await e.reply(text, parse_mode=None, link_preview=None )
        await event.edit(f"https://telegra.ph/file/264a11a7e6c2b8a8f0277.mp4","👑𝐌𝐀𝐒𝐓𝐄𝐑👑『😈[{ALIVE_NAME}](https://t.me/{USERNAME})😈 』","[🔥𝐑𝐄𝐏𝐎🔥](https://t.me/FATHER_SID_OP_SPAM_BOT)")
